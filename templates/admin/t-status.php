<li>
	...
	<input type="hidden" name="statuses[saved][<?php echo isset($id) ? $id : '' ?>][position]" data-name="statuses[new][count][position]" value="<?php echo isset($position) ? $position : '' ?>" class="position">
