<script class="template" type="t/template" data-id="filter-tags">
	...
	<div class="list-group-item field-filter" data-id="{{%fieldId}}">
		<div class="row">
			...
			<div class="col col-sm-4">
				<input type="text" class="form-control tags-filter-value" data-field-id="{{%fieldId}}" value="{{%storedFilter.filterValue}}">
			</div><!--col-->
		</div><!--row-->
	</div><!--list-group-item-->
