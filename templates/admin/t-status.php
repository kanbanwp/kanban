<li>
	...
	<label class="status-name">
		...
		<input type="text" name="statuses[saved][<?php echo isset($id) ? $id : ''; ?>][title]" data-name="statuses[new][count][title]" value="<?php echo isset($title) ? $title : ''; ?>">
	</label>
	<label class="status-color_hex">
		<input type="text" name="statuses[saved][<?php echo isset($id) ? $id : ''; ?>][color_hex]" data-name="statuses[new][count][color_hex]" class="color-picker" value="<?php echo isset($color_hex) ? strtolower($color_hex) : '#CCCCCC'; ?>"  data-default-color="#CCCCCC">
	</label>
