<div class="board tab-pane <?php echo $wp_query->query_vars['kanban']->current_board->id == $board_id ? 'active' : '' ?>" id="board-<?php echo $board_id ?>" data-id="<?php echo $board_id ?>" data-title="<?php echo $board->title ?>">
<?php /*
