...
class Kanban_Settings {
	...
	static function post_save_users() {
		if ( ! isset( $_POST[ Kanban_Utils::get_nonce() ] ) || ! wp_verify_nonce( $_POST[ Kanban_Utils::get_nonce() ], 'save_users' ) || ! is_user_logged_in() ) {
			return;
		}
	...
	static function post_save_status() {
		if ( ! isset( $_POST[ Kanban_Utils::get_nonce() ] ) || ! wp_verify_nonce( $_POST[ Kanban_Utils::get_nonce() ], 'save_status_order' ) || ! is_user_logged_in() ) {
			return;
		}
